...
class CircleFit
{
    private:
        ros::NodeHandle nh;
        pcl::PCLPointCloud2::Ptr laserCloudIn;
        //pcl::PointCloud<pcl::PointXYZIRT>::Ptr laserCloudIn;
        ros::Subscriber subLaserCloud;
        std::string pointCloudTopic;
    public:
        CircleFit(){
            nh.param<std::string>("lio_sam/pointCloudTopic", pointCloudTopic, "points_raw");
            subLaserCloud = nh.subscribe<sensor_msgs::PointCloud2>(pointCloudTopic, 5, &CircleFit::pointcallback, this, ros::TransportHints().tcpNoDelay());
