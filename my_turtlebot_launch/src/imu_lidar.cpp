...
class imuPreintegration
{
  ...
  public:
    imuPreintegration()
    {
      ...
      imu_odom_pub = nh.advertise<geometry_msgs::Point32> ("acc_wld", 2000);
      tnl_odom_pub = nh.advertise<nav_msgs::Odometry> ("tnl_odom", 2000);
      imuAccNoise = 0.001; imuGyrNoise = 0.001; imuGravity = 9.8;
      gravityOri << 0, 0, 0;
      delta_t = 0.1;
      lastImuT_imu = -1;
    ...
    void ImuHandler(const sensor_msgs::Imu::ConstPtr& msg)
    {
      ...
      double dt = (lastImuT_imu < 0) ? (0) : (imuTime - lastImuT_imu);
